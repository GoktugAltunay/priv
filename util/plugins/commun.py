...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} - ErencanDeniz Tarafindan Yapildi")
    elif system == 'posix':
        sys.stdout.write(f"\x1b]0;{_str} - ErencanDeniz Tarafindan Yapildi\x07")
    else:
        pass
...
def discserver():
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------\n{w}ErencanDeniz {b}|{w} itempazar.com/profil/erencandeniz {b}|{w} itempazar.com/profil/erencandeniz {b}|{w} itempazar.com/profil/erencandeniz {b}|{w} https://it\n{y}------------------------------------------------------------------------------------------------------------------------\n""")
